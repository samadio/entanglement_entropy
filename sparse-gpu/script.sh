...
#SBATCH --job-name=test       # The name of your job, you'll se it in squeue.
...
#SBATCH --cpus-per-task=1           # Number of threads per MPI rank (MAX: 2x32 cores on _partition_2, 2x20 cores on _partition_1)
...
module load gnu8 mkl/18.0.3.222 
module load intelpython3/3.6.8 cuda/10.1

python3.6 test.py >> output.txt
