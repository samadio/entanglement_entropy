...
numbers = [66] #, [15, 21,33,66,131]
maxiter = [2] #[450_000, 600_000, 45_000, 13_000, 1_600]
L_list = [aux.lfy(N) for N in numbers]
Y = 13
current_state = 0

#files = [open("/home/samadio/entropy/Entropy/1_percent/results_L_" + str(L) + "_" +str(maxiter[0]) +"_GPU_qiskit.py", 'a+') for L in L_list]
